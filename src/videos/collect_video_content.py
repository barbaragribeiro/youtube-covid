...
if __name__ == "__main__":
    ...
    videos = [ video for video in videos 
                   if not os.path.exists("{}/data/videos/{}/content.json".format(DIR_BASE, video))  ]
    ...
    for chunk_of_ids in video_chunks:
        ...
        videos_info = collect_video_info(chunk_of_ids, part="contentDetails")
        ...
        for video_id, statistics in videos_info:
            ...
            outfile_name = "{}/content.json".format(outdir)
